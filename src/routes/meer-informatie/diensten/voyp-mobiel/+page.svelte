			...
			<div class="relative group col-span-3">
				...
				>
					...
					<p class="pb-5">
						...
						niet écht zoals op kantoor. Door middel van een doorschakeling of een app op je mobiel
						ben je weliswaar bereikbaar, maar kun je niet alles wat je op kantoor kunt.
					</p>
					<p>
